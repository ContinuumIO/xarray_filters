...
works as expected.  Use random seed arg to control.

 * Call the original function with seed
 * Same seed - call the wrapped one
 *   Try different output options
 *   Ensure you get right data structure
 *   Check things like non-defauts, e.g. layers is None or not None
 *
